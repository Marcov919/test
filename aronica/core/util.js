...
export const clock = {
  ...
  // Demo time travel is shared by every server instance: it lives in settings
  // and is applied at the start of each request (see server/runtime.js).
  setOffset(ms) { clockOffset = Number(ms) || 0; },
